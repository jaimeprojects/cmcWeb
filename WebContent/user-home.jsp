...
<%
	...
	ArrayList<String> savedUni = dbc.getSavedByUser(u);
                    ...
                    <div class="faq-item">
                        <div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" role="tabpanel" id="tab-1"><button class="btn btn-primary float-right" type="button" style="background-color:#ff7474;">Add School</button>
